	...
	<input id="rfidKey" name="key" type="hidden" value="${request.rfid.key.name}"/>
		...
		<div class="clearfix">
	        ...
	        <div id="colorPicker" class="input" style="font-size:30px">
	        	<a class="color" href="#" style="color:rgb(0, 0, 255)">&#9632;</a>
	        	<a class="color" href="#" style="color:rgb(255, 165, 0)">&#9632;</a>
	        	<a class="color" href="#" style="color:rgb(173, 255, 47)">&#9632;</a>
	        	<a class="color" href="#" style="color:rgb(199, 21, 133)">&#9632;</a>
	        	<a class="color" href="#" style="color:rgb(192, 192, 192)">&#9632;</a>
	        	<a class="color" href="#" style="color:rgb(255, 255, 0)">&#9632;</a>
	        	<a class="color" href="#" style="color:rgb(255, 0, 0)">&#9632;</a>  
			</div>
			<script>
